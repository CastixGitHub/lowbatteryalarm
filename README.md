...
when your laptop's battery run out.

This is useful for windows managers such as [i3wm](i3wm.org) or if you do use graphics interfaces at all.
...
- **energy_now_file** string, file under **acpi_path** that contains the current level of the battery
